...
public class RobotMap {
    ...
    public static void init() {
    	...
    	driveTrainFrontLeftWheel = new WPI_TalonSRX(4);
    	driveTrainFrontRightWheel = new WPI_TalonSRX(1);
    	driveTrainRearLeftWheel = new WPI_TalonSRX(3);
    	driveTrainRearRightWheel = new WPI_TalonSRX(2);
...
//    	testSolenoid1 = new Solenoid(2);
    	...
    	driveTrainFrontLeftWheel.setNeutralMode(NeutralMode.Brake);
    	driveTrainFrontRightWheel.setNeutralMode(NeutralMode.Brake);
    	driveTrainRearLeftWheel.setNeutralMode(NeutralMode.Brake);
    	driveTrainRearRightWheel.setNeutralMode(NeutralMode.Brake);
    	//Encoders
